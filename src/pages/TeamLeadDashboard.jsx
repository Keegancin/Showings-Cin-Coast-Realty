...
// Team Lead Pages (extends Agent functionality)
  ...
  const header = (
    <div className="flex items-center justify-between p-4">
      <div>
        ...
        <p className="text-xs text-brand-gold">{user?.name} • Team Lead</p>
      </div>
      <button
  ...
  return (
    <MobileLayout header={header} bottomNav={bottomNav}>
      <Routes>
        ...
        <Route path="team/new" element={<CreateAgent />} />
